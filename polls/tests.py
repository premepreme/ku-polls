...
class QuestionModelTests(TestCase):
    ...
    def test_is_published_with_old_question(self):
        """is_published() have to returns
        True if pub_date already passed"""
    ...
    def test_can_vote_with_votable_question(self):
        """can_vote() have to return True for questions
        whose currentdate/time is exactly the pub_date
        or exactly the end_date (voting allowed)"""
    ...
    def test_can_vote_current_time_equal_to_end_date(self):
        ...
        question = Question(pub_date=past, end_date=expired_time)
        self.assertTrue(question.can_vote())
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        """
        self.client.login(username="demo", password="123456")
